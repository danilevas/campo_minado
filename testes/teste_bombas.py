...
#   - Só ganhar quando todas as bombas estiverem marcadas E todas as outras casas estiverem abertas
...
for i in range(colunas * linhas):
    ...
    coluna = i % colunas
    botoes[i].grid(row=linha, column=coluna)
    # print(f"Botao {i} na linha {linha} e coluna {coluna}")
